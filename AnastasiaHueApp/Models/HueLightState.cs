...
public class HueLightState
{
    ...
    /// </summary>
    [JsonProperty("xy")]
    public double[]? XyPoint { get; set; } = null;
    ...
    /// <summary>
    /// Helper method to retrieve an instance of <see cref="Color"/> from the current <see cref="Hue"/>, <see cref="Saturation"/> and <see cref="Brightness"/>.
    /// </summary>
